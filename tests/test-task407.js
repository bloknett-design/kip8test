...
describe('Task 407 — SRC: клиент', () => {
    ...
    test('_renderInstrSection: группы, сроки, «вне списка»', () => {
        ...
        assertTrue(fn.indexOf("this._normInstrKey(all[li].тема) === gKey") !== -1,
            'связка по нормализованному названию');
    ...
    test('SW поднят (SW_VERSION = kipia-test-v645)', () => {
        assertTrue(SW_SRC.indexOf('kipia-test-v645') !== -1,
            'CACHE_VERSION в sw.js — kipia-test-v645');
    });
});
