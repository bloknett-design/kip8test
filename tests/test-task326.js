...
//   SW: kipia-test-v652 (v566 не существует).
//
...
describe('Task 326 BUGFIX — структура HTML: закрытие #page-work-schedule', () => {
    ...
    test('SW: актуальная версия kipia-test-v652 (Task 326)', () => {
        assertTrue(SW_SRC.indexOf("const CACHE_VERSION = 'kipia-test-v652'") !== -1,
            'CACHE_VERSION = kipia-test-v652 в sw.js');
        assertFalse(SW_SRC.indexOf('kipia-test-v653') !== -1,
