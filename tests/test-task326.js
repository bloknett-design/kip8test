...
//   SW: kipia-test-v590 (v566 не существует).
//
...
describe('Task 326 BUGFIX — структура HTML: закрытие #page-work-schedule', () => {
    ...
    test('SW: актуальная версия kipia-test-v590 (Task 326)', () => {
        assertTrue(SW_SRC.indexOf("const CACHE_VERSION = 'kipia-test-v590'") !== -1,
            'CACHE_VERSION = kipia-test-v590 в sw.js');
