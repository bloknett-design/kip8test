...
// Task 424 — блок «Мероприятия»: eventsInit — инициализация листов
// «Инструктажи»+«Мероприятия» табель_КИП_ИОС (разовый запуск в
// редакторе Apps Script), перенос легаси-строк, архив eventsAll;
// соответствие блока: select типов обучение/прогул/примечание
