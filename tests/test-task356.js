...
//     — sw.js: CACHE_VERSION = kipia-test-v603 (+ guard v586).
...
describe('Task 356 — Service Worker', () => {
    test('SW: версия кэша kipia-test-v603', () => {
        assertTrue(SW_SRC.indexOf("CACHE_VERSION = 'kipia-test-v603'") !== -1,
            'CACHE_VERSION в sw.js = kipia-test-v603');
    });

    test('SW: двойной бамп не случился (v586 не существует)', () => {
        assertTrue(SW_SRC.indexOf('kipia-test-v604') === -1,
            'в sw.js нет kipia-test-v603');
    });
});
