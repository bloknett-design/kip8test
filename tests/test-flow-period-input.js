...
//      Task 292 — заголовок dailyMode «Показания (посуточно)»; SW → v540 (Task 298).
...
describe('Task 286 — клиент: CSS и SW', () => {
    ...
    test('SW-кэш поднят до v540 (Task 298 — фронтенд менялся)', () => {
        assertTrue(SW_SRC.indexOf("CACHE_VERSION = 'kipia-test-v540'") !== -1,
