...
//     — sw.js: CACHE_VERSION = kipia-test-v599 (+ guard v586).
...
describe('Task 355 — Service Worker', () => {
    test('SW: версия кэша kipia-test-v599', () => {
        assertTrue(SW_SRC.indexOf("CACHE_VERSION = 'kipia-test-v599'") !== -1,
            'CACHE_VERSION в sw.js = kipia-test-v599');
    });

    test('SW: двойной бамп не случился (v585 не существует)', () => {
        assertTrue(SW_SRC.indexOf('kipia-test-v600') === -1,
            'в sw.js нет kipia-test-v599');
    });
});
