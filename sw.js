...
// лист «Отпуска» таблицы табель_КИП_ИОС (периоды 2–3 частей на
// год), страница «Отпуска», субнавигация модуля (Шахматка /
// Сотрудники / Инструктажи / Отпуска), план «О» в пустых ячейках,
...
const CACHE_VERSION = 'kipia-test-v531';
