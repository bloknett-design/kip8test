...
// Task 255: правка разметки шахматки — линии-границы выходных/рабочих
// дней тоньше (1px) и приглушённее, убраны из шапки; селекты месяца/года
// без скруглений; в подпись должности добавлен режим занятости
// («Слесарь КИПиА смена №1» / «Слесарь КИПиА дневной»).
const CACHE_VERSION = 'kipia-test-v514';
