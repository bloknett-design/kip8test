...
// Task 254: визуальная разметка шахматки — розовый фон пустых ячеек
// выходных, красные линии-границы выходных/рабочих дней, должность под
// ФИО, непрозрачный тулбар, кнопки без скруглений.
const CACHE_VERSION = 'kipia-test-v512';
